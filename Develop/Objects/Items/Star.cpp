...
void Star::Initialize()
{
	...
	anim_img = rm->GetImages("Resource/Images/Item/star.png", 4, 4, 1, 32, 32);

	is_mobility = true;

	collision.is_blocking = true;
	collision.object_type = eObjectType::eStar;
...
void Star::Draw(const Vector2D camera_pos) const
{
...
void Star::OnHitCollision(GameObject* hit_object)
{
...
void Star::AnimationControl(float delta_second)
{
